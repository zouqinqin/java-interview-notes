...
- 销售邮件，了解当前的逾期情况
![reconcile-receivable-email-sales.png](../Images/work/reconcile-receivable-email-sales.png)
- GM 邮件 了解团队催收进度
![reconcile-receivable-email-gm.png](../Images/work/reconcile-receivable-email-gm.png)
...
![accrual-adjust-single-input.png](../Images/work/accrual-adjust-single-input.png)
...
![accrual-adjust-batch-input.png](../Images/work/accrual-adjust-batch-input.png)
